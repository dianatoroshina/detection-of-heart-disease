...
train_dataset = Pool(data=x, label=data_train['condition'])
model = CatBoostClassifier(iterations=100, learning_rate=0.5, loss_function='MultiClass', 
                          random_seed=11, bootstrap_type='MVS', custom_metric='WKappa')
...
print('CatBoost', round(cohen_kappa_score(data_test['target'], data_test['condition'], weights='quadratic'), 3))
